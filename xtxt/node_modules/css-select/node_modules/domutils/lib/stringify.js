...
function getOuterHTML(elem){
	...
	var ret = "<" + elem.name; if("attribs" in elem){ for(var attr elem.attribs){ if(elem.attribs.hasownproperty(attr)){ ret attr; var value="elem.attribs[attr];" if(value="=" null){ if( !(attr booleanattribs) ){ \""; } else { " "\""; if (elem.name emptytags && elem.children.length="==" 0) return>";
	} else {
