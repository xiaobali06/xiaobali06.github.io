...
describe('$(...)', function() {
  ...
  describe('.after', function() {
    ...
    it('($(...)) : should remove from root element', function() {
      var $plum = $('</li><li class="plum">Plum</li>');
      var root = $plum[0].root;
      expect(root).to.be.ok();
  ...
  describe('.replaceWith', function() {
    ...
    it('(Array) : should replace one <li> tag with the elements in the array', function() {
      var more = $('</li><li class="plum">Plum</li><li class="grape">Grape</li>')
        .get();
...
</div></div></baz></bar></foo></div></div></div></div></div></div>