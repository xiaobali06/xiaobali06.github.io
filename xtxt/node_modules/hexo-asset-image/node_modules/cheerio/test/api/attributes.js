...
describe('$(...)', function() {
  ...
  describe('.attr', function() {
    ...
    it('(key, value) : should correctly encode then decode unsafe values', function() {
      var $apple = $('.apple');
      $apple.attr('href', 'http://github.com/"><script>alert("XSS!")</script><br'); expect($apple.attr('href')).to.equal('http: github.com "><script>alert("XSS!")</script><br'); $apple.attr('href', 'http: github.com "><script>alert("XSS!")</script><br'); expect($apple.html()).to.not.contain('<script>alert("XSS!")');
    });
  ...
  describe('.data', function() {
    ...
    describe('(attr) : data-* attribute type coercion :', function() {
      ...
      it('object', function() {
        var $el = cheerio('<div 45 data-obj="\'{" "a": }\'>');
...
</div></div></div></div></div></div></div></div></div></div></div></div></div></div></br');></br');></br');>